...
if rails_master?
  ...
  gem 'actionmailer', '>= 6.1.7.5', rails_version
  gem 'actionpack', '>= 6.1.7.5', rails_version
  gem 'actionview', '>= 6.1.7.5', rails_version
  gem 'activemodel', '>= 6.1.7.5', rails_version
  gem 'activerecord', '>= 6.1.7.5', rails_version
  gem 'activesupport', '>= 6.1.7.5', rails_version
  gem 'railties', '>= 6.1.7.5', rails_version
  gem 'sprockets-rails'
end
...
group :development do
  ...
  gem 'bullet', '>= 7.0.2', require: !!ENV['BULLET']
