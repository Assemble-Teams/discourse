...
if rails_master?
  ...
  gem 'actionview', '>= 6.1.7.1', rails_version
  gem 'activemodel', '>= 6.1.7.1', rails_version
  gem 'activerecord', '>= 6.1.7.1', rails_version
  gem 'activesupport', '>= 6.1.7.1', rails_version
